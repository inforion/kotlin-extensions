...
//val jacksonMappers = Array(16) { jacksonJsonParser() }
//
//inline fun <reified T: Any> String.parseJson(m: ObjectMapper = jacksonMappers.random()) = m.readValue<T>(this)
//
//inline fun <reified T: Any> InputStream.parseJson(m: ObjectMapper = jacksonMappers.random()) = m.readValue<T>(this)
//
//inline fun <reified T: Any> File.parseJson(m: ObjectMapper = jacksonMappers.random()) = m.readValue<T>(this)
//
//inline fun <reified T: Any> File.writeJson(data: T, m: ObjectMapper = jacksonMappers.random()) = m.writeValue(this, data)
//
...
//
//inline fun <reified T: Any> T.writeJson(m: ObjectMapper = jacksonMappers.random()) = m.writeValueAsString(this)