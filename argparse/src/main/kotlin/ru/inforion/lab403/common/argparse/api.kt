...
import ru.inforion.lab403.common.argparse.options.*
 ...
 * @since 0.3.4
 */
inline fun <reified T: ApplicationOptions> Array<String>.parseArguments(): T =
 ...
 * @since 0.3.4
 */
inline fun <reified T: ApplicationOptions> List<String>.parseArguments(): T = toTypedArray().parseArguments<T>()
 ...
 * @since 0.3.4
 */
inline fun <reified T: ApplicationOptions> String.parseArguments(): T =
