...
inline infix fun LongRange.isIntersect(other: LongRange) = intersect(other).length > 0
...
inline infix fun IntRange.isIntersect(other: IntRange) = intersect(other).length > 0
inline infix fun IntRange.isNotIntersect(other: IntRange) = !isIntersect(other)

inline infix fun ULongRange.intersect(other: ULongRange) = max(first, other.first)..max(last, other.last)
inline infix fun ULongRange.isIntersect(other: ULongRange) = intersect(other).length > 0u
