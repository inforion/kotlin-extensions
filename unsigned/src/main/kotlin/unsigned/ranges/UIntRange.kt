 ...
 */
class UIntRange(start: UInt, endInclusive: UInt) : UIntProgression(start, endInclusive, 1), ClosedRange<UInt> {
    ...
    companion object {
        ...
        val EMPTY: UIntRange = UIntRange(UInt.MAX_VALUE, UInt.MIN_VALUE)
    }
}
...
internal constructor(
     ...
     */
    val last: UInt = getProgressionLastElement(start, endInclusive, step)
    ...
    companion object {
         ...
         */
        fun fromClosedRange(rangeStart: UInt, rangeEnd: UInt, step: Int): UIntProgression = UIntProgression(rangeStart, rangeEnd, step)
    }
}
