 ...
 */
class ULongRange(start: ULong, endInclusive: ULong) : ULongProgression(start, endInclusive, 1), ClosedRange<ULong> {
    ...
    companion object {
        ...
        val EMPTY: ULongRange = ULongRange(ULong.MAX_VALUE, ULong.MIN_VALUE)
    }
}
...
internal constructor(
     ...
     */
    val last: ULong = getProgressionLastElement(start, endInclusive, step)
    ...
    companion object {
         ...
         */
        fun fromClosedRange(rangeStart: ULong, rangeEnd: ULong, step: Long): ULongProgression = ULongProgression(rangeStart, rangeEnd, step)
    }
}
